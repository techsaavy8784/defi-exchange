...
function Wallet() {
  ...
  useEffect(() => {
    ...
    fetchBNBPrice();
    const intervalId = setInterval(fetchBNBPrice, 60000);
    return () => clearInterval(intervalId);
  }, []);
  return (
    <>
                ...
                <Row className="w-full">
                  ...
                  >
                    ...
                    <div className="flex mx-auto">
                      <div>
                        <p className="mr-4 text-3xl font-bold myColor1">
                          {t("Total Price")}
                        </p>
                      ...
                      <div>
                        <p className="text-3xl font-bold myColor1">
                        ...
                        {/* <div>
                          {account ? (
                            <div>
                              <Button
                                type="primary"
                                className="text-x1 myColor1 rounded"
